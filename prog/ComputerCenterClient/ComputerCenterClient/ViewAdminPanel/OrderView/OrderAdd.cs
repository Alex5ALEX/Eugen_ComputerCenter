...
public partial class OrderAdd : UserControl
{
    ...
    public CustomerDTO choisedCustomer { get; set; } = new CustomerDTO();
    ...
    private async void InitCustomers()
    {
        ...
        List<CustomerDTO> customers = await mainController.customerController.GetAll();
    ...
    {
        label2.Text = choisedCustomer.Person.Name;
        label4.Text = choisedCustomer.Person.Surname;
        label6.Text = choisedCustomer.Person.Phone;
        label8.Text = choisedCustomer.Person.Email;
        label10.Text = choisedCustomer.Person.Address;
    }
    ...
    {
        if(choisedCustomer.Customer.Id == Guid.Empty)
        {
        ...
        Order order = new Order()
        {
            ...
            Id_Customer = choisedCustomer.Customer.Id
        };
