        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Manufacture = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ManufactureId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Services = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    OrderId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    ServicesId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasedServices", x => new { x.Id_Order, x.Id_Services });
                    table.ForeignKey(
                        name: "FK_PurchasedServices_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchasedServices_Services_ServicesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasedProducts", x => new { x.Id_Order, x.Id_Product });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedServices_OrderId",
                table: "PurchasedServices",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedServices_ServicesId",
                table: "PurchasedServices",
                column: "ServicesId");
        }
